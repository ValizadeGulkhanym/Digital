(() => {
  ...
  function n(e = {}, i = {}) {
    Object.keys(i).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = i[s])
        : t(i[s]) && t(e[s]) && Object.keys(i[s]).length > 0 && n(e[s], i[s]);
    });
  }
  const i = {
    body: {},
          ...
          void 0 !== r &&
            ...
            (b(e[s]) && b(i[s])
              ? i[s].__swiper__
                ...
                : y(e[s], i[s])
              : !b(e[s]) && b(i[s])
              ? ((e[s] = {}), i[s].__swiper__ ? (e[s] = i[s]) : y(e[s], i[s]))
              : (e[s] = i[s]));
        }
      }
    }
  ...
  const I = {
    slideTo: function (e, t, n, i, s) {
      ...
      if ((r.animating && o.preventInteractionOnTransition) || (!h && !i && !s))
        return !1;
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!r.support.smoothScroll)
            return (
              S({ swiper: r, targetPosition: n, side: e ? "left" : "top" }), !0
            );
  ...
  function D(e) {
    ...
    if (!n.allowTouchMove)
      return (
        h(d.target).is(i.focusableElements) || (n.allowClick = !1),
        void (
          i.isTouched &&
  ...
  function G(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (b >= i.longSwipesRatio
          ? t.slideTo(i.rewind && t.isEnd ? h : p + w)
          : t.slideTo(p)),
      ...
      (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl)
        ? l.target === t.navigation.nextEl
          ? t.slideTo(p + w)
          : t.slideTo(p)
        : ("next" === t.swipeDirection && t.slideTo(null !== h ? h : p + w),
  ...
  class Q {
    ...
    mount(e) {
      ...
      let r = (() => {
        ...
        return n.children ? n.children(i()) : h(n).children(i());
      })();
      ...
      new Z(
        ...
        (function (t) {
          for (var n = 1; n < arguments.length; n++) {
            ...
            n % 2
              ? ie(Object(i), !0).forEach(function (n) {
                  e(t, n, i[n]);
                })
        ...
        })(
          {
            ...
            pagination: {
              el: "".concat(n, ".swiper-pagination"),
              type: "bullets",
              clickable: !0,
            },
            navigation: {
              nextEl: "".concat(n, " .swiper-button-next"),
              prevEl: "".concat(n, " .swiper-button-prev"),
            },
          },
          i
        )
      );
      var s = document.querySelectorAll('[data-role="gallery"]');
      0 !== s.length &&
  ...
  Z.use([
    ...
    function (e) {
      ...
      function c() {
        ...
        if (
          ("fraction" === n.type &&
            (r.find(te(n.currentClass)).text(n.formatFractionCurrent(c + 1)),
            r.find(te(n.totalClass)).text(n.formatFractionTotal(u))),
          "progressbar" === n.type)
        ) {
          let e;
      ...
      function p() {
        ...
        0 !== n.length &&
          (t.params.uniqueNavElements &&
            ...
            ((n = t.$el.find(e.el)),
            n.length > 1 &&
              (n = n.filter((e) => h(e).parents(".swiper")[0] === t.el))),
          ...
          e.clickable &&
            n.on("click", te(e.bulletClass), function (e) {
              e.preventDefault();
      ...
      function f() {
        ...
        n.removeClass(e.hiddenClass),
          ...
          e.clickable && n.off("click", te(e.bulletClass));
      }
      i("init", () => {
        !1 === t.params.pagination.enabled ? m() : (p(), u(), c());
      }),
        i("activeIndexChange", () => {
        ...
        i("click", (e, n) => {
          ...
          if (
            ...
            r.length > 0 &&
            !h(i).hasClass(t.params.pagination.bulletClass)
          ) {
            if (
              t.navigation &&
            ...
            (n ? t.slides.find(n) : t.slides).transition(e),
              (function (e) {
                ...
                if (t.params.virtualTranslate && 0 !== n) {
                  let e,
                    n = !1;
                  (e = s ? (i ? r.find(i) : r) : i ? r.eq(a).find(i) : r.eq(a)),
                    e.transitionEnd(() => {
                      if (n) return;
    ...
    function (e) {
      ...
      function a() {
        ...
        const n = e.clickedIndex,
          i = e.clickedSlide;
        if (i && h(i).hasClass(t.params.thumbs.slideThumbActiveClass)) return;
        if (null == n) return;
        let s;
        if (
          ((s = e.params.loop
            ? parseInt(h(e.clickedSlide).attr("data-swiper-slide-index"), 10)
            : n),
          t.params.loop)
        ) {
          let e = t.activeIndex;
  ...
  function ce(e) {
    return e.bind.apply(e, [null].concat(de(arguments, 1)));
  }
  var ue = setTimeout,
    pe = function () {};
  function fe(e) {
  ...
  function ze(e) {
    return (
      de(arguments, 1).forEach(function (t) {
        _e(t, function (n, i) {
          e[i] = t[i];
        });
      }),
  ...
  function Be(e, t, n) {
    me(t)
      ...
      : Ee(e, function (e) {
          ye(n) || "" === n ? Ne(e, t) : e.setAttribute(t, String(n));
        });
  }
  function je(e, t, n) {
    var i = document.createElement(e);
    return t && (be(t) ? ke(i, t) : Be(i, t)), n && Me(n, i), i;
  }
  function Fe(e, t, n) {
  ...
  function Je(e, t) {
    return t ? de(e.querySelectorAll(t)) : [];
  }
  function Qe(e, t) {
    Pe(e, t, !1);
  }
  ...
  function vt() {
    ...
    return {
      bind: function (n, i, s, r) {
        t(n, i, function (t, n, i) {
          var a = "addEventListener" in t,
            o = a
              ? t.removeEventListener.bind(t, n, s, r)
              : t.removeListener.bind(t, s);
          a ? t.addEventListener(n, s, r) : t.addListener(s),
            e.push([t, n, i, s, o]);
        });
      },
      ...
      dispatch: function (e, t, n) {
        ...
        return (
          "function" == typeof CustomEvent
            ? (i = new CustomEvent(t, { bubbles: true, detail: n }))
  ...
  function Ft(e) {
    var t = e ? e.event.bus : document.createDocumentFragment(),
      n = vt();
    return (
      e && e.event.on(zt, n.destroy),
      ze(n, {
        bus: t,
        on: function (e, i) {
          n.bind(t, Se(e).join(" "), function (e) {
            i.apply(i, ge(e.detail) ? e.detail : []);
          });
        },
        off: ce(n.unbind, t),
        emit: function (e) {
          n.dispatch(t, e, de(arguments, 1));
        },
      })
    );
  }
  function Ht(e, t, n, i) {
    ...
    function p() {
      r && cancelAnimationFrame(r), (o = 0), (r = 0), (l = !0);
    }
    return {
      start: function (t) {
        !t && p(), (s = a() - (t ? o * e : 0)), (l = !1), fe(c);
      },
      rewind: function () {
        (s = a()), (o = 0), n && n(o);
      },
  ...
  function Ut(e, t, n) {
    return {
      resolve: function (e, t, i) {
        var s = "rtl" !== (i = i || n.direction) || t ? (i === Xt ? 0 : -1) : 1;
        return (
          (Yt[e] && Yt[e][s]) ||
          e.replace(/width|left|right/i, function (e, t) {
            var n = Yt[e.toLowerCase()][s] || e;
  ...
  var Kt = "role",
    ...
    ln = "aria-busy",
    dn = "aria-atomic",
    cn = [Kt, Jt, "disabled", Qt, Zt, tn, nn, sn, rn, an],
    un = tt,
    pn = "splide__track",
    fn = "splide__list",
    hn = "splide__slide",
    ...
    bn = vn + "--prev",
    wn = vn + "--next",
    yn = "splide__pagination",
    Cn = yn + "__page",
    Sn = "splide__progress__bar",
    En = "splide__toggle",
    xn = "is-active",
    Tn = "is-prev",
    Pn = "is-next",
  ...
  var An = "touchstart mousedown",
    ...
    _n = "touchend touchcancel mouseup click";
  var zn = "slide",
    Dn = "loop",
    Gn = "fade";
  function Nn(e, t, n, i) {
    var s,
      ...
      w = Ve(i, tn),
      y = n > -1,
      C = Ae(i, ".splide__slide__container"),
      S = Je(i, u.focusableNodes || "");
    function E() {
      var s = e.splides
        .map(function (e) {
    ...
    function T() {
      if (!s) {
        var n = e.index;
        (r = P()) !== Re(i, xn) &&
          (Pe(i, xn, r), Be(i, Zt, (p && r) || ""), o(r ? xt : Tt, k)),
          (function () {
            var t = (function () {
                if (e.is(Gn)) return P();
                var t = We(d.Elements.track),
                  n = We(i),
                  s = v("left", !0),
                  r = v("right", !0);
                return at(t[s]) <= ot(n[s]) && at(n[r]) <= ot(t[r]);
              })(),
              n = !t && (!P() || y);
            e.state.is([4, 5]) || Be(i, sn, n || "");
            Be(S, Jt, n ? -1 : ""), g && Be(i, Jt, n ? -1 : 0);
            t !== Re(i, kn) && (Pe(i, kn, t), o(t ? Pt : kt, k));
    ...
    var k = {
      ...
      mount: function () {
        y ||
          ((i.id = c.id + "-slide" + ht(t + 1)),
          Be(i, Kt, m ? "tabpanel" : "group"),
          Be(i, an, h.slide),
          Be(i, tn, w || ft(h.slideLabel, [t + 1, e.length]))),
          l(i, "click", ce(o, Et, k)),
          l(i, "keydown", ce(o, Mt, k)),
          a([Ct, St, _t], T),
          a(Gt, E),
          f && a(yt, x);
      },
      ...
      isWithin: function (n, i) {
        var s = lt(n - t);
        return (
          y || (!u.rewind && !e.is(Dn)) || (s = st(s, e.length - s)), s <= i
        );
      },
    };
    return k;
  ...
  var Hn = { Spacebar: " ", Right: Vt, Left: qt, Up: Rt, Down: Wt };
  function qn(e) {
    return (e = be(e) ? e : e.key), Hn[e] || e;
  }
  var Vn = "keydown";
  var Rn = "data-splide-lazy",
    Wn = "data-splide-lazy-srcset";
  var Xn = [" ", "Enter"];
  var Yn = Object.freeze({
      ...
      Media: function (e, t, n) {
        ...
        function d(e, t) {
          var n = matchMedia(t);
          a.bind(n, "change", c), o.push([e, n]);
        }
        function c() {
          var t = i.is(7),
            s = n.direction,
            r = o.reduce(function (e, t) {
              return De(e, t[1].matches ? t[0] : {});
            }, {});
          Ge(n),
            u(r),
            n.destroy
              ...
              : t
              ? (l(!0), e.mount())
              : s !== n.direction && e.refresh();
        }
        function u(t, s) {
          De(n, t),
            s && De(Object.getPrototypeOf(n), t),
            i.is(1) || e.emit($t, n);
        }
        return {
          setup: function () {
          ...
          destroy: l,
          reduce: function (e) {
            matchMedia(ae).matches && (e ? De(n, r) : Ge(n, Ie(r)));
          },
          set: u,
        };
      },
      ...
      Elements: function (e, t, n) {
        ...
        function m() {
          (i = b("." + pn)),
            (s = Ae(i, "." + fn)),
            it(i && s, "A track/list element is missing."),
            Te(p, Oe(s, ".splide__slide:not(." + mn + ")")),
            _e(
              {
                arrows: gn,
                pagination: yn,
            ...
            ze(u, { root: d, track: i, list: s, slides: p }),
            (function () {
              var e = d.id || gt(tt),
                t = n.role;
              (d.id = e),
                (i.id = i.id || e + "-track"),
                (s.id = s.id || e + "-list"),
                !Ve(d, Kt) && "SECTION" !== d.tagName && t && Be(d, Kt, t);
              Be(d, an, c.carousel), Be(s, Kt, "presentation");
            })(),
            v();
        }
        function g(e) {
        ...
        function v() {
          Qe(d, f),
            ...
            ke(i, h),
            Be(d, tn, n.label),
            Be(d, nn, n.labelledby);
        }
        function b(e) {
          var t = Ke(d, e);
          return t &&
            (function (e, t) {
              if (ve(e.closest)) return e.closest(t);
        ...
        function g(e) {
          return c.filter(
            ve(e)
              ? e
              : function (t) {
                  return be(e) ? $e(t.slide, e) : xe(Se(e), t.index);
                }
          );
        }
        return {
      ...
      Layout: function (e, t, n) {
        ...
        function v() {
          (s = null),
            (i = n.direction === Xt),
            Fe(p, "maxWidth", et(n.width)),
            Fe(f, c("paddingLeft"), w(!1)),
            Fe(f, c("paddingRight"), w(!0)),
            b();
        }
        function b() {
          var e = We(p);
          (s && s.width === e.width && s.height === e.height) ||
            (Fe(
              ...
              (function () {
                var e = "";
                i &&
                  (it((e = y()), "height or heightRatio is missing."),
                  (e = "calc(" + e + " - " + w(!1) + " - " + w(!0) + ")"));
                return e;
              })()
            ),
            g(c("marginRight"), et(n.gap)),
            g("width", n.autoWidth ? null : et(n.fixedWidth) || (i ? "" : C())),
            g(
              "height",
              et(n.fixedHeight) || (i ? (n.autoHeight ? null : C()) : y()),
              !0
            ),
            (s = e),
            l(At));
        ...
        function w(e) {
          var t = n.padding,
            i = c(e ? "right" : "left");
          return (t && et(t[i] || (me(t) ? 0 : t))) || "0px";
        }
        function y() {
          return et(n.height || We(h).width * n.heightRatio);
        }
        function C() {
          var e = et(n.gap);
          return (
        ...
        function E() {
          var e = m(0);
          return (e && parseFloat(Fe(e.slide, c("marginRight")))) || 0;
        }
        return {
          mount: function () {
            var e, t, n;
          ...
          slideSize: function (e, t) {
            var n = m(e || 0);
            return n ? We(n.slide)[c("width")] + (t ? 0 : E()) : 0;
          },
          sliderSize: function () {
            return S(e.length - 1, !0) - S(-1, !0);
          },
          totalSize: S,
          getPadding: function (e) {
            return (
              parseFloat(Fe(f, c("padding" + (e ? "Right" : "Left")))) || 0
            );
          },
        };
      },
      Clones: function (e, t, n) {
          ...
          (i = h()) &&
            (!(function (t) {
              var i = l.get().slice(),
                s = i.length;
              if (s) {
                for (; i.length < t; ) Te(i, i);
                Te(i.slice(-t), i.slice(0, t)).forEach(function (r, a) {
                  var d = a < t,
                    u = (function (t, i) {
                      var s = t.cloneNode(!0);
                      return (
                        ke(s, n.classes.clone),
                        (s.id = e.root.id + "-clone" + ht(i + 1)),
                        s
                      );
                    })(r.slide, a);
                  d ? Le(u, i[0].slide) : Me(o.list, u),
                    Te(c, u),
                    l.register(u, a - t + (d ? 0 : s), r.index);
                });
              }
            })(i),
            a(Ot));
        ...
        function h() {
          ...
          if (e.is(Dn)) {
            if (!i) {
              var s = n[d("fixedWidth")] && t.Layout.slideSize(0);
              i =
                (s && ot(We(o.track)[d("width")] / s)) ||
      ...
      Move: function (e, t, n) {
        ...
        function S(n, i) {
          if (!e.is(Gn)) {
            ...
            Fe(b, "transform", "translate" + m("X") + "(" + s + "px)"),
              n !== s && a(St);
          }
        }
        function E(e, t) {
          var n = e - M(t),
            i = f();
          return (e -= g(i * (ot(lt(n) / i) || 1)) * (t ? 1 : -1));
        }
        function x() {
          S(k()), i.cancel();
        }
        function T(e) {
          for (
            var n = t.Slides.get(), i = 0, s = 1 / 0, r = 0;
            r < n.length;
            r++
          ) {
            var a = n[r].index,
        ...
        function P(t, i) {
          var s = g(
            u(t - 1) -
              (function (e) {
                var t = n.focus;
                return "center" === t ? (p() - d(e, !0)) / 2 : +t * d(e) || 0;
              })(t)
          );
          return i
            ? (function (t) {
                n.trimSpace && e.is(zn) && (t = ut(t, 0, g(f() - p())));
                return t;
              })(s)
            : s;
        }
        ...
        return {
          ...
          move: function (e, t, n, s) {
            ...
            e !== t &&
              ((r = e > n),
              (l = g(E(k(), r))),
              r ? l >= 0 : l <= b[m("scrollWidth")] - We(w)[m("width")]) &&
              (x(), S(E(k(), e > n), !0)),
              o(4),
              a(yt, t, n, e),
              i.start(t, function () {
      ...
      Controller: function (e, t, n) {
        var i,
          ...
          w = b;
        function y() {
          (i = f(!0)), (s = n.perMove), (r = n.perPage);
          var e = ut(b, 0, i - 1);
          e !== b && ((b = e), o.reposition());
        }
        function C(e, t) {
          var n = s || (M() ? 1 : r),
            i = S(b + n * (e ? -1 : 1), b, !(s || M()));
          return -1 === i && m && !dt(l(), d(!e), 1)
            ? e
              ? 0
              : x()
            : t
        ...
        function S(t, a, o) {
          if (p()) {
            var d = x(),
              u = (function (t) {
                if (m && "move" === n.trimSpace && t !== b)
                  for (
                    var i = l();
                    i === c(t, !0) && ct(t, 0, e.length - 1, !n.rewind);
        ...
        function x() {
          return rt(i - (M() || (h && s) ? 1 : r), 0);
        }
        function T(e) {
          return ut(M() ? e : r * e, 0, x());
        }
        function P(e) {
          return M() ? e : at((e >= x() ? i - 1 : e) / r);
        }
        function k(e) {
          e !== b && ((w = b), (b = e));
        }
      ...
      Arrows: function (e, t, n) {
        ...
        function C() {
          r.destroy(),
            Qe(m, s),
            i ? (Xe(f ? [g, v] : m), (g = v = null)) : Ne([g, v], cn);
        }
        function S(e) {
          p.go(e, !0);
        }
        ...
        function x() {
          var t = e.index,
            n = p.getPrev(),
            i = p.getNext(),
            s = n > -1 && t < n ? c.last : c.prev,
            r = i > -1 && t > i ? c.first : c.next;
          (g.disabled = n < 0),
            (v.disabled = i < 0),
            Be(g, tn, s),
            Be(v, tn, r),
      ...
      Autoplay: function (e, t, n) {
        var i,
          ...
          o = r.bind,
          l = r.emit,
          d = Ht(n.interval, e.go.bind(e, ">"), function (e) {
            var t = u.bar;
            t && Fe(t, "width", 100 * e + "%"), l("autoplay:playing", e);
          }),
          c = d.isPaused,
          u = t.Elements,
          p = t.Elements,
        ...
        function v() {
          c() &&
            t.Slides.isEnough() &&
            (d.start(!n.resetProgress), (s = i = g = !1), y(), l(Nt));
        }
        function b(e) {
          void 0 === e && (e = !0), (g = !!e), y(), c() || (d.pause(), l(Bt));
        }
        function w() {
          g || (i || s ? b(!1) : v());
        }
        function y() {
          h && (Pe(h, xn, !g), Be(h, tn, n.i18n[g ? "play" : "pause"]));
        }
        function C(e) {
          var i = t.Slides.getAt(e);
          d.set((i && +Ve(i.slide, "data-splide-interval")) || n.interval);
        }
        return {
          mount: function () {
            m &&
              (!(function () {
                n.pauseOnHover &&
                  o(f, "mouseenter mouseleave", function (e) {
                    (i = "mouseenter" === e.type), w();
                  });
                n.pauseOnFocus &&
                  o(f, "focusin focusout", function (e) {
                    (s = "focusin" === e.type), w();
                  });
                h &&
                  o(h, "click", function () {
                ...
                a([yt, It, Lt], d.rewind), a(yt, C);
              })(),
              h && Be(h, Qt, u.track.id),
              g || v(),
              y());
          },
          destroy: d.cancel,
      ...
      Cover: function (e, t, n) {
        ...
        return {
          mount: function () {
            n.cover && (i(jt, ce(r, !0)), i([bt, $t, Lt], ce(s, !0)));
          },
          destroy: ce(s, !1),
        };
      },
      Scroll: function (e, t, n) {
        var i,
          ...
          f = d.translate,
          h = 1;
        function m(e, n, r, a, u) {
          var p = c();
          if ((b(), r)) {
            var f = t.Layout.sliderSize(),
              m = pt(e) * f * at(lt(e) / f) || 0;
            e = d.toPosition(t.Controller.toDest(e % f)) + m;
          }
          var w = dt(p, e, 1);
          (h = 1),
            (n = w ? 0 : n || rt(lt(e - p) / 1.5, 800)),
            (s = a),
            (i = Ht(n, g, ce(v, p, e, u), 1)),
            l(5),
            o(It),
            i.start();
        }
          ...
          var o,
            ...
            g =
              (t +
                (i - t) *
                  ((o = a),
                  (l = n.easingFunc) ? l(o) : 1 - Math.pow(1 - o, 4)) -
                d) *
              h;
          f(d + g),
            e.is(zn) &&
              !r &&
              p() &&
              ((h *= 0.6), lt(g) < 10 && m(u(p(!0)), 600, !1, s, !0));
        }
        function b() {
          i && i.cancel();
        }
      ...
      Drag: function (e, t, n) {
        ...
        function L(e) {
          if (((l = !1), !d)) {
            ...
            (i = e.target),
              (s = n.noDrag),
              $e(i, ".splide__pagination__page, ." + vn) ||
                (s && $e(i, s)) ||
                (!t && e.button) ||
                (w.isBusy()
                  ? Ue(e, !0)
        ...
        function $(t) {
          if ((g.is(6) || (g.set(6), f("drag")), t.cancelable))
            if (o) {
              v.translate(i + _(t) / (k && e.is(zn) ? 5 : 1));
              var s = z(t) > 200,
                r = k !== (k = P());
              (s || r) && I(t), (l = !0), f("dragging"), Ue(t);
            } else
              (function (e) {
                return lt(_(e)) > lt(_(e, !0));
              })(t) &&
                ((o = (function (e) {
                  var t = n.dragMinThreshold,
                    ...
                    s = (i && t.mouse) || 0,
                    r = (i ? t.touch : +t) || 10;
                  return lt(_(e)) > (N(e) ? r : s);
                })(t)),
                Ue(t));
        }
        function O(i) {
          g.is(6) && (g.set(3), f("dragged")),
            o &&
              (!(function (i) {
                var s = (function (t) {
                    if (e.is(Dn) || !k) {
        ...
        function G(e, t) {
          return (N(e) ? e.changedTouches[0] : e)["page" + E(t ? "Y" : "X")];
        }
        function N(e) {
      ...
      Keyboard: function (e, t, n) {
        ...
        function u() {
          var e = n.keyboard;
          e && ((i = "global" === e ? window : d), o(i, Vn, h));
        }
        function p() {
          l(i, Vn);
        }
        ...
        function h(t) {
          if (!s) {
            var n = qn(t);
            n === c(qt) ? e.go("<") : n === c(Vt) && e.go(">");
          }
        }
        return {
          mount: function () {
            u(), a($t, p), a($t, u), a(yt, f);
          },
          destroy: p,
          disable: function (e) {
            s = e;
      ...
      LazyLoad: function (e, t, n) {
              ...
              Je(
                ...
                if (i !== t.src || s !== t.srcset) {
                  var r = n.classes.spinner,
                    a = t.parentElement,
                    o = Ae(a, "." + r) || je("span", r, a);
                  c.push([t, e, o]), t.src || He(t, "none");
                }
              });
            }),
            l && m();
        ...
        function h(e, t) {
          var n = e[0],
            i = e[1];
          Qe(i.slide, Mn),
            "error" !== t.type && (Xe(e[2]), He(n, ""), o(jt, n, i), o(Ot)),
            l && m();
        }
        function m() {
          c.length && f(c.shift());
      ...
      Pagination: function (e, t, n) {
        ...
        function v() {
          i &&
            (Xe(c.pagination ? de(i.children) : i),
            Qe(i, s),
            le(g),
            (i = null)),
            r.destroy();
        ...
        function S() {
          ...
          if (e) {
            var n = e.button;
            Qe(n, xn), Ne(n, en), Be(n, Jt, -1);
          }
          if (t) {
            var s = t.button;
            ke(s, xn), Be(s, en, !0), Be(s, Jt, "");
          }
          o("pagination:updated", { list: i, items: g }, e, t);
        }
        return {
          items: g,
          mount: function t() {
              ...
              n.pagination &&
                ...
                (function () {
                  ...
                  ke(
                    (i =
                      c.pagination ||
                      je("ul", r.pagination, c.track.parentElement)),
                    (s = yn + "--" + y())
                  ),
                    Be(i, Kt, "tablist"),
                    Be(i, tn, a.select),
                    Be(i, rn, y() === Xt ? "vertical" : "");
                  for (var f = 0; f < u; f++) {
                    var h = je("li", null, i),
                      m = je("button", { class: r.page, type: "button" }, h),
                      v = d.getIn(f).map(function (e) {
                        return e.slide.id;
                      }),
                      C = !p() && o > 1 ? a.pageX : a.slideX;
                    l(m, "click", ce(b, f)),
                      n.paginationKeyboard && l(m, "keydown", ce(w, f)),
                      Be(h, Kt, "presentation"),
                      Be(m, Kt, "tab"),
                      Be(m, Qt, v.join(" ")),
                      Be(m, tn, ft(C, f + 1)),
                      Be(m, Jt, -1),
                      g.push({ li: h, button: m, page: f });
                  }
                })(),
                S(),
                o("pagination:mounted", { list: i, items: g }, C(e.index)));
          },
          destroy: v,
          getAt: C,
          update: S,
      ...
      Sync: function (e, t, n) {
        ...
        function l(e, t) {
          var n = Ft(e);
          n.on(yt, function (e, n, i) {
            t.go(t.is(Dn) ? i : e);
          }),
            r.push(n);
        }
        function d() {
          Be(t.Elements.list, rn, n.direction === Xt ? "vertical" : "");
        }
        function c(t) {
          e.go(t.index);
        }
      ...
      Wheel: function (e, t, n) {
        ...
        return {
          mount: function () {
            n.wheel && i(t.Elements.track, "wheel", r, Fn);
          },
        };
      },
      Live: function (e, t, n) {
        var i = Ft(e).on,
          ...
          a = je("span", "splide__sr"),
          o = Ht(90, ce(l, !1));
        function l(e) {
          Be(s, ln, e), e ? (Me(s, a), o.start()) : Xe(a);
        }
        function d(e) {
          r && Be(s, on, e ? "off" : "polite");
        }
        return {
          mount: function () {
            r &&
  ...
  function Jn(e, t, n) {
    var i,
      ...
      o = t.Scroll,
      l = t.Elements.list,
      d = ce(Fe, l, "transition");
    function c() {
      d(""), o.cancel();
    }
    return {
      mount: function () {
        s(l, "transitionend", function (e) {
          e.target === l && i && (c(), i());
        });
      },
      start: function (t, s) {
        var l = r.toPosition(t, !0),
          c = r.getPosition(),
          u = (function (t) {
            var i = n.rewindSpeed;
            if (e.is(zn) && i) {
  ...
  var Qn = (function () {
      function e(t, n) {
        ...
        (this.event = Ft()),
          ...
          (this._o = {}),
          (this._E = {});
        var s = be(t) ? Ke(document, t) : t;
        it(s, s + " is invalid."),
          (this.root = s),
          (n = De(
            { label: Ve(s, tn) || "", labelledby: Ve(s, nn) || "" },
            Un,
            e.defaults,
            n || {}
          ));
        try {
          De(n, JSON.parse(Ve(s, nt)));
        } catch (e) {
          it(!1, "Invalid JSON");
        }
        this._o = Object.create(De({}, n));
      }
      var t,
        n,
        i,
      ...
      return (
        (s.mount = function (e, t) {
          var n = this,
            ...
            s = this.Components;
          return (
            it(i.is([1, 7]), "Already mounted!"),
            i.set(1),
            (this._C = s),
            (this._T = t || this._T || (this.is(Gn) ? Kn : Jn)),
            (this._E = e || this._E),
            _e(ze({}, Yn, this._E, { Transition: this._T }), function (e, t) {
              var i = e(n, s, n._o);
        ...
        (s.emit = function (e) {
          var t;
          return (
            (t = this.event).emit.apply(t, [e].concat(de(arguments, 1))), this
          );
        }),
        (s.add = function (e, t) {
        ...
        (s.destroy = function (e) {
          ...
          return (
            n.is(1)
              ? Ft(this).on(wt, this.destroy.bind(this, e))
              : (_e(
                  this._C,
                  function (t) {
    ...
    Zn = Qn;
  (Zn.defaults = {}), (Zn.STATES = oe);
  document.addEventListener("DOMContentLoaded", function () {
    se(".presentation", ".presentation_nav", {
      slidesPerView: 1,
      autoplay: !0,
      speed: 1300,
      effect: "fade",
      ...
      (function () {
        var e = new Zn(".cases_slider", {
          ...
          breakpoints: {
            ...
            767.98: { gap: 30 },
            1023.98: { gap: 50 },
            1169.98: { perPage: 3, focus: "center" },
            1365.98: { gap: 100 },
            1769.98: { gap: 140 },
          },
        });
        ...
        var n = document.querySelector(".splide__arrow--prev"),
          i = document.querySelector(".splide__arrow--next");
        n.addEventListener("click", function (t) {
          t.stopPropagation(), e.go("-1");
        }),
